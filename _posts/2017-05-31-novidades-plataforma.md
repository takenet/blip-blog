...
{% include image.html name="templateMaster.png" alt="Template Master" %}
...
{% include image.html name="contatos1.png" alt="Contatos 01" %}

{% include image.html name="contatos2.png" alt="Contatos 02" %}

### BLiP Chat

Agora no BLiP chat quando o Bot envia uma imagem e o cliente clica na imagem ela aparece em full screen.

{% include image.html name="full1.png" alt="Image full 1" %}

{% include image.html name="full2.png" alt="Image full 2" %}
